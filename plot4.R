...
plot(datetime, HPCFeb$Global_active_power, type = "l", ylab = "Global Active Power", xlab = "")
plot(datetime, HPCFeb$Voltage, type = "l", ylab = "Voltage", xlab = "datetime")
...
plot(datetime, HPCFeb$Global_reactive_power, type = "l", ylab = "Global_Reactive_Power", xlab = "datetime")
